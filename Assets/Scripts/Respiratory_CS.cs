...
public class Respiratory_CS : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Combine_Button.GetComponent<Button>().enabled = false;
    ...
    public void Divide()
    {
        ...
        resetbtn.GetComponent<EventTrigger>().enabled = false;
        ...
        Divide_Button.GetComponent<Button>().enabled = false;
        for (int i = 0; i < a.Length; i++)
        {
    ...
    public void Divide_End()
    {
        ...
        if (Counter >= 1)
        {
            ...
            Combine_Button.GetComponent<Button>().enabled = true;
            ...
            resetbtn.GetComponent<EventTrigger>().enabled = true;
        }
    }
    ...
    public void Combine_End()
    {
        ...
        if (Counter >= 1)
        {
            ...
            Divide_Button.GetComponent<Button>().enabled = true;
            Divide_Button.GetComponent<Image>().sprite = asdfstart;
    ...
    public void option()
    {
        ...
        if (w.GetComponent<Main>().start == true) {
            if (a1_ == false)
            {
        ...
        {
            dad.transform.localPosition = new Vector3(2.23f, 0.09f, 1.97f);
